...
func init() {
	...
	pkg.CLI.Flags().BoolVarP(&pkg.SkipTLS, "skip-tls", "s", true, "Run OADP server requests with insecure TLS connections (recommended if a custom CA certificate is used) (default true)")
	// TODO caCertFile?
